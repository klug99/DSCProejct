...
#quadgram <- readRDS("/home/minseo/Coursera/Project/Data Science Capstone/Project0608/nfreq.f4.RData");
#trigram <- readRDS("/home/minseo/Coursera/Project/Data Science Capstone/Project0608/nfreq.f3.RData");
#bigram <- readRDS("/home/minseo/Coursera/Project/Data Science Capstone/Project0608/nfreq.f2.RData");
quadgram <- readRDS("D:/R/RProject/nfreq.f4.RData");
trigram <- readRDS("D:/R/RProject/nfreq.f3.RData");
bigram <- readRDS("D:/R/RProject/nfreq.f2.RData");
mesg <<- ""
...
# Back Off Algorithm
# 1. Quadgram is first used (first three words of Quadgram are the last three words of the user provided sentence).
